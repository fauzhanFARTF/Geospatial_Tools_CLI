...
def convert_shp_to_kml(input_folder, output_folder):
    """
    Mengonversi semua file SHP dalam subfolder dan sub-subfolder ke kml,
    ...
    for shp_path in shp_files:
        try:
            ...
            if len(path_levels) == 2:
                ...
                output_kml = os.path.join(output_folder, f"{shp_name}_{timestamp}.kml")
                ...
                output_kml = os.path.join(output_subfolder, f"{shp_name}_{timestamp}.kml")
            else:
